            ...
            <div id="content">
               <div class="panel box-shadow-none content-header">
                  ...
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h1 class="animated fadeInLeft">ACCOUNT TRANSACTION HISTORY</h1>
                    ...
                    <div class="panel-heading"><h3>Account Transaction History</h3></div>
                      ...
                      <div class="panel-heading"><h3>BANK ACCOUNT INFO</h3></div>
                        ...
                        <thead>
                          ...
                          <tbody>
                            <?php
                              $query = "SELECT * FROM payment_tbl WHERE bai_id=$bai_id";
                        ...
                        <div class="col-md-4">
                          <a href="index.php"><button type="button" class="btn btn-default btn-block"><span class="glyphicon glyphicon-chevron-left"> &nbsp;BACK</span></button></a>
                        </div>
                       </div>
                       </div>
                     </div>
