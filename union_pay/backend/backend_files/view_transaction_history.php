...
if(isset($_GET['or_no'])){
  $or_no=$_GET['or_no'];
  $q_res = $database->query("SELECT * FROM payment_tbl where or_no = '$or_no'");

  foreach($q_res AS $q_res_data){
  $bai_id = $q_res_data["bai_id"];
  $reserve_date = $q_res_data["reserve_date"];
  $payment_date = $q_res_data["payment_date"];
            ...
            <div id="content">
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h1 class="animated fadeInLeft">VIEW TRANSACTION HISTORY</h1>
                        <p class="animated fadeInDown" >
                          This section will show the view transaction history.
                        </p>
                    </div>
                </div>
              </div>
              <div class="col-md-12 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>VIEW TRANSACTION HISTORY</h3></div>
                      ...
                      <div class="row">
                        <div class="col-md-12" style="background-color:#fb8c00;">
                          <div class="col-md-4">
                              <h5 style="color:white;font-size:14px;"><b>CLIENT NAME : <?php echo $bai_fname.", ".$bai_fname." ".$bai_mname; ?>
                                <b></h5>
                          </div>
                           <div class="col-md-4">
                      ...
                      <br>
                        ...
                        <thead>
                          <tr>
                             ...
                             <th class="text-center">REVERSE CODE</th>
                          ...
                          <tbody>
                            <?php
                              ...
                              $q_res = $database->query("SELECT * FROM payment_tbl where or_no = '$or_no'");
                                foreach($q_res AS $q_res_data){
                                $or_no = $q_res_data["or_no"];
                                $prod_id = $q_res_data["prod_id"];
                                $reserve_code = $q_res_data["reserve_code"];
                                $bai_id = $q_res_data["bai_id"];
                                $prod_qty = $q_res_data["prod_qty"];

                                $q_qs=$database->query("SELECT * FROM product_tbl WHERE prod_id = '$prod_id' AND company_id = '$company_id'");
                                foreach($q_qs AS $q_qs_data){
                                    $prod_code = $q_qs_data["prod_code"];
                       ...
                       <div class="row">
                        ...
                        <div class="col-md-4">
                          <a href="company_transaction_history.php"><button type="button" class="btn btn-default btn-block"><span class="glyphicon glyphicon-chevron-left"> &nbsp;BACK</span></button></a>
                        </div>
                       </div>
                       </div>
                     </div>
