                ...
                ?>
                    <div class="panel-heading"><h3>BANK ACCOUNT INFO</h3></div>
                      <div class="row" style="padding-top:10px;">
                          <div class="col-md-12">
                            <div class="col-md-2">
                                <a href="add_partner_companies.php">
                      ...
                      <div class="panel-body">
                        ...
                        <thead>
                          ...
                          <tbody>
                            ...
                            $table2 = "company_tbl";
                            $columns2 = "*";
                            $q_c_tbl = $database->select($table2,$columns2);

                            foreach($q_c_tbl AS $q_bai_data){
                                $company_id = $q_bai_data["company_id"];
                                $company_name = $q_bai_data["company_name"];
                                $company_desc = $q_bai_data["company_desc"];
                                $company_status = $q_bai_data["company_status"];
                                $company_date_added = date("M/D/Y",strtotime($q_bai_data["company_date_added"]));
                            ?>
                            <tr>
                              <td><?php echo $company_name; ?></td>
                              <td><?php echo $company_desc; ?></td>
                              <td><?php echo $company_date_added; ?></td>
                              <td><?php echo $company_status; ?></td>
                              <td>
                                <a href="#" class="btn btn-outline btn-block btn-info">
                                  <span class="glyphicon glyphicon-pencil"></span> Update
                                </a>
                              </td>
                              <td>
                                <a href="view_pc_transaction_history.php?company_id=<?php echo $company_id; ?>" class="btn btn-outline btn-block btn-info">
