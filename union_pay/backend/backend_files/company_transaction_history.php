            ...
            <div id="content">
               <div class="panel box-shadow-none content-header">
                  <div class="panel-body">
                    <div class="col-md-12">
                        <h1 class="animated fadeInLeft">TRANSACTION HISTORY</h1>
                        <p class="animated fadeInDown" >
                          This section will show the transaction history.
                        </p>
                    </div>
                </div>
              </div>
              <div class="col-md-12 padding-0">
                <div class="col-md-12">
                  <div class="panel">
                    <div class="panel-heading"><h3>TRANSACTION HISTORY</h3></div>
                    <?php
                      ...
                      <div class="panel-body">
                        ...
                        <thead>
                          ...
                          <tbody>
                            <?php
                              $sql = "SELECT DISTINCT(or_no), reserve_code, CONCAT(bai_fname, ' ', bai_mname, ' ', bai_fname) AS client_name, reserve_date, payment_date FROM payment_tbl AS a LEFT JOIN bank_account_tbl AS b ON a.bai_id=b.bai_id LEFT JOIN product_tbl AS c ON a.prod_id=c.prod_id WHERE c.company_id=$company_id";
                              $reserveDatas = $database->query($sql)->fetchAll();

                              foreach ($reserveDatas as $reserveData) {
                                echo "
                                <tr>
                                <td>" . $reserveData['or_no'] . "</td>
                                <td>" . $reserveData['reserve_code'] . "</td>
                                <td>" . $reserveData['client_name'] . "</td>
                                <td>" . $reserveData['reserve_date'] . "</td>
                                <td>" . $reserveData['payment_date'] . "</td>
                                <td>
                                  <a href='view_transaction_history.php?or_no=" . $reserveData['or_no'] . "' class='btn btn-outline btn-block btn-primary'>
